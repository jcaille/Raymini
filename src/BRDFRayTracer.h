...
class BRDFRayTracer : public RayTracer
{

public :
    static BRDFRayTracer *getInstance();
     ...
     */
    bool rayObjectIntersection(const Ray &ray, const Object &object, float &intersectionDistance, Vec3Df &intersectionColor);
    
protected:
    inline BRDFRayTracer () {}
    inline virtual ~BRDFRayTracer () {}
